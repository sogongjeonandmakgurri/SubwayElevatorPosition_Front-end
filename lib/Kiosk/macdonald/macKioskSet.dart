...
import 'macKioskSet2.dart';

class MacKioskSet extends StatefulWidget {
  const MacKioskSet({Key? key}) : super(key: key);

  @override
  State<MacKioskSet> createState() => _MacKioskState();
}

class _MacKioskState extends State<MacKioskSet> {
            ...
            Column(
              children: [
                ...
                Container(height: MediaQuery.of(context).size.height * 0.4,
                  child: Image.asset('assets/mcset.png'),
                  decoration: BoxDecoration(
                    border: Border.all(),
                  ),
                ),
