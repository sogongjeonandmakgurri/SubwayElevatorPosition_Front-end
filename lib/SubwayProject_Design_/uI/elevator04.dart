...
class dongbanjaIPhone1312ProMax12 extends StatelessWidget {
  dongbanjaIPhone1312ProMax12({
    Key? key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(start: 44.0, end: 42.0),
            Pin(size: 51.0, middle: 0.7509),
            child: Container(
          ...
          Align(
            alignment: Alignment(0.017, -0.271),
            child: Container(
              width: 196.0,
              height: 196.0,
              decoration: BoxDecoration(
          ...
          Align(
            alignment: Alignment(0.02, -0.284),
            child: Container(
              width: 228.0,
              height: 228.0,
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 290.0, end: 64.0),
            Pin(size: 41.0, middle: 0.6384),
            child: Text(
              '역으로 들어가십니까?',
              style: TextStyle(
                fontFamily: 'Pretendard',
          ...
          Align(
            alignment: Alignment(0.012, 0.494),
            child: SizedBox(
              width: 260.0,
              height: 41.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.012, -0.225),
            child: SizedBox(
              width: 98.0,
              height: 92.0,
              child: Text.rich(
